# Eval Report: server-side blocklist filter (案A)

- date: 2026-04-14T14:23:04Z
- git_commit: unknown
...
## Pair comparison vs FINAL: case 011 reworded, all session improvements

- baseline: `/eval-data/reports/final_session.json`
- common cases: 11

| stage / metric | improved | regressed | tied |
|---|---|---|---|
| Stage 1: must_include_coverage | 0 | 0 | 11 |
| Stage 1: must_exclude_violations | 3 | 0 | 8 |
...
| Stage 3: citation_segment_match (median) | 0 | 1 | 10 |
