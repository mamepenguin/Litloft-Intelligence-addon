# Eval Report: dual-query (raw for vec, keywords for FTS)

- date: 2026-04-14T11:44:53Z
- git_commit: unknown
...
| Stage 3: citation_in_ground_truth (median) | 0.75 |
...
## Pair comparison vs gemma4:e2b + query_transform max_tokens=256

- baseline: `/eval-data/reports/gemma_maxtok_fix.json`
- common cases: 8
...
| Stage 2: recall@5 (file) | 2 | 0 | 6 |
| Stage 2: recall@10 (file) | 2 | 0 | 6 |
| Stage 2: segment recall@5 | 0 | 0 | 8 |
| Stage 2: MRR | 0 | 0 | 8 |
| Stage 3: must_mention (median) | 0 | 0 | 8 |
| Stage 3: citation_in_ground_truth (median) | 1 | 2 | 5 |
| Stage 3: citation_segment_match (median) | 0 | 1 | 7 |
| Stage 3: citation_in_retrieved (median) | 0 | 2 | 6 |
