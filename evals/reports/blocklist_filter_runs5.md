# Eval Report: 案A + variance check (runs=5)

- date: 2026-04-14T14:39:12Z
- git_commit: unknown
...
## Pair comparison vs server-side blocklist filter (案A)

- baseline: `/eval-data/reports/server_blocklist_filter.json`
- common cases: 11
