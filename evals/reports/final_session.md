# Eval Report: FINAL: case 011 reworded, all session improvements

- date: 2026-04-14T13:57:51Z
- git_commit: unknown
...
| Stage 3: citation_segment_match (median) | 0.75 |
...
|---|---|---|---|
| Stage 1: must_include_coverage | 1 | 0 | 10 |
| Stage 1: must_exclude_violations | 1 | 0 | 10 |
| Stage 2: recall@5 (file) | 0 | 0 | 11 |
| Stage 2: recall@10 (file) | 0 | 0 | 11 |
| Stage 2: segment recall@5 | 1 | 0 | 10 |
| Stage 2: MRR | 1 | 0 | 10 |
| Stage 3: must_mention (median) | 1 | 0 | 10 |
| Stage 3: citation_in_ground_truth (median) | 1 | 0 | 10 |
| Stage 3: citation_segment_match (median) | 1 | 0 | 10 |
| Stage 3: citation_in_retrieved (median) | 1 | 0 | 10 |
