# Eval Report: MatchInfo-level segment_location

- date: 2026-04-14T15:05:09Z
- git_commit: unknown
...
## Pair comparison vs 案A + variance check (runs=5)

- baseline: `/eval-data/reports/blocklist_filter_runs5.json`
- common cases: 11
