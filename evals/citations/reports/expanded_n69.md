...
- has_citation precision: **75.4%**  _(when a citation was returned, it pointed at an exact-hit chunk)_
...
- mean: **0.97**  median (p50): **0.0**  p95: **7.0**  max: **15**

| threshold | hit rate (offset ≤ N) |
|---|---:|
| offset ≤ 0 | 75.4% _(== strict top-1 accuracy)_ |
| offset ≤ 1 | 88.4% |
| offset ≤ 2 | 88.4% |
| offset ≤ 5 | 94.2% |
...
| [0.85-0.90) | 16 | 1.12 | 0.0 | 62.5% |
| ≥0.90 | 43 | 0.47 | 0.0 | 83.7% |
...
| `詳細内容/10` | bullet | 1 | ✅ | ✅ | 0.93 | `transcript:78`, `transcript:77`, `transcript:76` |
...
| `結論/0` | paragraph | 1 | ✅ | ✅ | 0.87 | `transcript:58`, `transcript:59`, `transcript:57` |
