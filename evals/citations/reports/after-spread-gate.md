# detailed_summary Citation Eval — paragraph-spread-gate

_Generated: 2026-04-20 11:02:35 UTC_

## Aggregate

- total segments scored: **69**
- has_citation precision: **77.9%**  _(when a citation was returned, it pointed at an exact-hit chunk)_
...
- mean: **0.85**  median (p50): **0.0**  p95: **4.0**  max: **15**

| threshold | hit rate (offset ≤ N) |
|---|---:|
| offset ≤ 0 | 77.9% _(== strict top-1 accuracy)_ |
| offset ≤ 1 | 88.2% |
| offset ≤ 2 | 89.7% |
| offset ≤ 5 | 95.6% |
...
| [0.80-0.85) | 8 | 2.50 | 0.0 | 62.5% |
| [0.85-0.90) | 16 | 0.62 | 0.0 | 68.8% |
...
| `詳細内容：人生を切り開くための二つの指針/0` | paragraph | — | ❌ | ❌(required) | 0.85 | — |
...
|---|---:|---:|---:|
| top1_accuracy | 78.3% | 76.8% | -1.4% ❌ |
| recall_at_3 | 88.4% | 87.0% | -1.4% ❌ |
| has_citation_precision | 78.3% | 77.9% | -0.3% (tied) |
