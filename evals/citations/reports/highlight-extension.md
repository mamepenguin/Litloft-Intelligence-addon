# detailed_summary Citation Eval — highlight-extension

_Generated: 2026-04-20 01:54:52 UTC_
...
- mean: **0.84**  median (p50): **0.0**  p95: **4.0**  max: **15**
...
|---|---:|---:|---:|
| top1_accuracy | 78.3% | 78.3% | +0.0% (tied) |
| recall_at_3 | 88.4% | 88.4% | +0.0% (tied) |
| has_citation_precision | 78.3% | 78.3% | +0.0% (tied) |
