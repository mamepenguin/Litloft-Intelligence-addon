# detailed_summary Citation Eval — no_dp

_Generated: 2026-04-19 12:40:46 UTC_
...
|---|---|:-:|:-:|:-:|---:|---|
| `導入/0` | paragraph | ✅ | ✅ | ✅ | 0.94 | `transcript:2`, `transcript:0`, `transcript:1` |
| `詳細内容/0` | bullet | ✅ | ✅ | ✅ | 0.92 | `transcript:2`, `transcript:3` |
| `詳細内容/4` | bullet | ✅ | ✅ | ✅ | 0.93 | `transcript:9`, `transcript:12`, `transcript:11` |
| `詳細内容/7` | bullet | ✅ | ✅ | ✅ | 0.90 | `transcript:27`, `transcript:23`, `transcript:15` |
...
| section_path | type | top1 | r@3 | has_cit | score | chunks |
|---|---|:-:|:-:|:-:|---:|---|
| `導入/0` | paragraph | ✅ | ✅ | ✅ | 0.96 | `transcript:4`, `transcript:3` |
| `詳細内容/0` | paragraph | ✅ | ✅ | ✅ | 0.90 | `transcript:0`, `transcript:9`, `transcript:49` |
| `詳細内容/1` | bullet | ✅ | ✅ | ✅ | 0.92 | `transcript:0`, `transcript:27`, `transcript:20` |
| `詳細内容/2` | bullet | ✅ | ✅ | ✅ | 0.93 | `transcript:0`, `transcript:53`, `transcript:20` |
| `詳細内容/3` | bullet | ✅ | ✅ | ✅ | 0.89 | `transcript:1`, `transcript:0`, `transcript:53` |
| `詳細内容/4` | paragraph | ❌ | ✅ | ✅ | 0.89 | `transcript:41`, `transcript:2`, `transcript:14` |
...
| section_path | type | top1 | r@3 | has_cit | score | chunks |
|---|---|:-:|:-:|:-:|---:|---|
| `詳細内容/6` | paragraph | ✅ | ✅ | ✅ | 0.93 | `transcript:5`, `transcript:4`, `transcript:8` |
| `詳細内容/7` | bullet | ✅ | ✅ | ✅ | 0.94 | `transcript:5`, `transcript:8`, `transcript:4` |
| `詳細内容/9` | bullet | ✅ | ✅ | ✅ | 0.96 | `transcript:8`, `transcript:5`, `transcript:4` |
| `詳細内容/14` | bullet | ✅ | ✅ | ✅ | 0.90 | `transcript:15`, `transcript:18`, `transcript:16` |
| `詳細内容/15` | bullet | ✅ | ✅ | ✅ | 0.88 | `transcript:18`, `transcript:15`, `transcript:16` |
...
| section_path | type | top1 | r@3 | has_cit | score | chunks |
|---|---|:-:|:-:|:-:|---:|---|
| `詳細内容/11` | bullet | ✅ | ✅ | ✅ | 0.84 | `transcript:53`, `transcript:51`, `transcript:54` |
| `詳細内容/23` | bullet | ✅ | ✅ | ✅ | 0.88 | `transcript:92`, `transcript:85`, `transcript:86` |
| `詳細内容/29` | bullet | ❌ | ❌ | ✅ | 0.91 | `transcript:92`, `transcript:88`, `transcript:91` |
| `詳細内容/37` | bullet | ✅ | ✅ | ✅ | 0.92 | `transcript:110`, `transcript:113`, `transcript:116` |
