# detailed_summary Citation Eval — paragraph-section-first-bias

_Generated: 2026-04-19 16:42:27 UTC_

## Aggregate

- total segments scored: **69**
- has_citation precision: **73.5%**  _(when a citation was returned, it pointed at an exact-hit chunk)_
- missing required citations: **1**  _(must_have_citation=true segments flipped to ⚠)_

### Location offset (primary metric)

``offset_at_top1`` = chunk-index distance between the system's top-1 chunk and the nearest ground-truth chunk. 0 = exact hit, 1–2 = adjacent, 5+ = different part of the file. Computed only for segments with known GT (68 of 69).

- mean: **1.00**  median (p50): **0.0**  p95: **4.6**  max: **15**

| threshold | hit rate (offset ≤ N) |
|---|---:|
| offset ≤ 0 | 73.5% _(== strict top-1 accuracy)_ |
| offset ≤ 1 | 83.8% |
| offset ≤ 2 | 86.8% |
| offset ≤ 5 | 95.6% |
...
| [0.80-0.85) | 10 | 2.20 | 0.0 | 60.0% |
| [0.85-0.90) | 19 | 1.00 | 0.0 | 57.9% |
| ≥0.90 | 38 | 0.47 | 0.0 | 86.8% |
...
|---|---|:-:|:-:|:-:|---:|---|
| `導入/0` | paragraph | 0 ✅ | ✅ | ✅ | 0.94 | `transcript:0`, `transcript:2`, `transcript:3` |
...
| section_path | type | offset | r@3 | has_cit | score | chunks |
|---|---|:-:|:-:|:-:|---:|---|
| `導入/0` | paragraph | 3 | ✅ | ✅ | 0.90 | `transcript:0`, `transcript:3`, `transcript:4` |
...
| `詳細内容/4` | paragraph | 1 | ✅ | ✅ | 0.85 | `transcript:1`, `transcript:2`, `transcript:3` |
...
| section_path | type | offset | r@3 | has_cit | score | chunks |
|---|---|:-:|:-:|:-:|---:|---|
| `詳細内容/6` | paragraph | 1 | ✅ | ✅ | 0.83 | `transcript:3`, `transcript:4`, `transcript:5` |
...
| `詳細内容/20` | paragraph | 5 | ✅ | ✅ | 0.86 | `transcript:13`, `transcript:18`, `transcript:14` |
...
| section_path | type | offset | r@3 | has_cit | score | chunks |
|---|---|:-:|:-:|:-:|---:|---|
| `導入/0` | paragraph | 2 | ✅ | ✅ | 0.82 | `transcript:0`, `transcript:1`, `transcript:2` |
| `詳細内容/2` | bullet | 0 ✅ | ✅ | ✅ | 0.91 | `transcript:15`, `transcript:14`, `transcript:11` |
| `詳細内容/17` | bullet | 0 ✅ | ✅ | ✅ | 0.90 | `transcript:59`, `transcript:61`, `transcript:58` |
...
| `詳細内容/5` | bullet | 0 ✅ | ✅ | ✅ | 0.90 | `transcript:40`, `transcript:41`, `transcript:30` |
| `詳細内容/10` | bullet | 0 ✅ | ✅ | ✅ | 0.89 | `transcript:77`, `transcript:79`, `transcript:76` |
...
| section_path | type | offset | r@3 | has_cit | score | chunks |
|---|---|:-:|:-:|:-:|---:|---|
| `導入：スピーチの心構えと現状認識/0` | paragraph | 9 | ❌ | ✅ | 0.80 | `transcript:0`, `transcript:1`, `transcript:2` |
| `詳細内容：人生を切り開くための二つの指針/0` | paragraph | — | ❌ | ❌(required) | 0.72 | — |
| `詳細内容：人生を切り開くための二つの指針/1` | bullet | 2 | ❌ | ✅ | 0.89 | `transcript:28`, `transcript:21`, `transcript:22` |
...
| section_path | type | offset | r@3 | has_cit | score | chunks |
|---|---|:-:|:-:|:-:|---:|---|
| `導入/0` | paragraph | 0 ✅ | ✅ | ✅ | 0.87 | `transcript:0`, `transcript:1`, `transcript:2` |
| `詳細内容/11` | bullet | 0 ✅ | ✅ | ✅ | 0.88 | `transcript:20`, `transcript:21`, `transcript:10` |
...
| `5. 海賊版対策に関する質疑応答（文化庁担当者）/3` | paragraph | 0 ✅ | ✅ | ✅ | 0.81 | `transcript:36`, `transcript:37`, `transcript:35` |
...
| `2. 主要コンテンツの詳細解説/11` | paragraph | 0 ✅ | ✅ | ✅ | 0.92 | `transcript:33`, `transcript:35`, `transcript:34` |
...
| section_path | type | offset | r@3 | has_cit | score | chunks |
|---|---|:-:|:-:|:-:|---:|---|
| `詳細内容/9` | bullet | 0 ✅ | ✅ | ✅ | 0.93 | `transcript:31`, `transcript:18`, `transcript:21` |
| `詳細内容/15` | bullet | 0 ✅ | ✅ | ✅ | 0.92 | `transcript:46`, `transcript:43`, `transcript:47` |
| `詳細内容/22` | bullet | 0 ✅ | ✅ | ✅ | 0.92 | `transcript:67`, `transcript:68`, `transcript:65` |
| `詳細内容/24` | bullet | 0 ✅ | ✅ | ✅ | 0.92 | `transcript:73`, `transcript:71`, `transcript:65` |
...
| `詳細内容/6` | paragraph | 0 ✅ | ✅ | ✅ | 0.89 | `document:1`, `document:2`, `document:3` |
...
|---|---:|---:|---:|
| top1_accuracy | 78.3% | 72.5% | -5.8% ❌ |
| recall_at_3 | 88.4% | 87.0% | -1.4% ❌ |
| has_citation_precision | 78.3% | 73.5% | -4.7% ❌ |
